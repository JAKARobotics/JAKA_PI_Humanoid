...
def import_packages():
    sys.path.insert(0, f"{pathlib.Path(__file__).parent.parent}/project/jaka_rl_lab/tasks/")
    for package in ["locomotion.envs", "mimic.envs"]:
...
def main():
    """Print all environments registered in `jaka_rl_lab` extension."""
    # print all the available environments
    table = PrettyTable(["S. No.", "Task Name", "Entry Point", "Config"])
    table.title = "Available Environments in JAKA RL Lab"
