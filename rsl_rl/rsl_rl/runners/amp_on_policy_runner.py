...
class AmpOnPolicyRunner:
    ...
    def learn(self, num_learning_iterations: int, init_at_random_ep_len: bool = False):  # noqa: C901
        ...
        amp_obs = self.env.unwrapped.get_amp_obs_for_expert_trans()
        ...
        for it in range(start_iter, tot_iter):
            ...
            with torch.inference_mode():
                for _ in range(self.num_steps_per_env):
                    ...
                    next_amp_obs = self.env.unwrapped.get_amp_obs_for_expert_trans()
                    # Move to device
                    ...
                    reset_env_ids = self.env.unwrapped.reset_buf.nonzero(as_tuple=False).flatten()
                    terminal_amp_states = self.env.unwrapped.get_amp_obs_for_expert_trans()[reset_env_ids]
